...
export const TILE_ACCESS_RULES: TileAccessRule[] = [
  ...
  { id: "t-register", label: "Register Patient", group: "tablet" },
  ...
  { id: "t-discharge-summary", label: "Discharge Summary", group: "tablet" },
  { id: "t-doctor-notes", label: "Doctor Notes", group: "tablet" },
  { id: "t-ot-schedule-gaurav", label: "OT Schedule", group: "tablet" },
  { id: "t-rmo-duty-gaurav", label: "RMO Duty", group: "tablet" },
  { id: "t-rmo-duty-javed", label: "RMO Duty (Ayushman)", group: "tablet" },
  { id: "t-ot-photos-sarvesh", label: "OT Photos", group: "tablet" },
  { id: "t-implant-servesh", label: "Implant Tools", group: "tablet" },
  ...
  { id: "t-referee-ruby", label: "Referee Register", group: "tablet" },
  { id: "t-referee-viji", label: "Referee Approvals", group: "tablet" },
