...
const FLOWS: Record<string, LazyExoticComponent<ComponentType>> = {
  ...
  "discharged-rm-cuts": lazy(() => import("@/tablet/modules/discharged-rm-cuts/DischargedRmCutsFlow")),
  ...
  "payment-proof": lazy(() => import("@/tablet/modules/payment-proof/PaymentProofFlow")),
  "stores-inventory": lazy(() => import("@/pages/StoresInventory")),
  ...
  "cash-handover": lazy(() => import("@/tablet/modules/cash-handover/CashHandoverFlow")),
