...
export const TABLET_MODULES: TabletModule[] = [
  ...
  },
  {
    ...
    roles: ["superadmin", "super_admin", "admin", "cmd", "director"],
  },
  {
    id: "canteen-sonu",
    label: "Canteen - Reena",
  ...
  {
    id: "reconciliation-tilak",
    label: "Reconciliation - Tilak",
    description: "Phone and bank payments against the bills the system holds",
    icon: ArrowLeftRight,
    accent: "text-cyan-700",
  ...
  {
    id: "phonepe-nisha",
    label: "PhonePe History - Nisha",
    description: "Upload today's history before handing the phone back",
    icon: Camera,
  ...
  {
    id: "phonepe-akshay",
    label: "PhonePe History - Akshay",
    description: "Upload today's history before handing the phone back",
    icon: Camera,
    accent: "text-teal-700",
    tint: "from-teal-500 to-emerald-700",
  },
  {
  ...
  },
  {
    ...
    description: "Create, edit & print summary",
    icon: FileText,
  ...
  {
    id: "dialysis-rakesh",
    label: "Dialysis - Rakesh",
    description: "Who came, and which sessions are still unbilled",
    icon: Droplets,
    accent: "text-sky-700",
    tint: "from-sky-400 to-blue-600",
  },
  ...
  },
  {
    ...
    keywords: ["opening", "locker", "cash in hand", "start of shift", "cashier", "nisha"],
  },
  {
    id: "cash-handover",
    ...
    accent: "text-emerald-600",
    tint: "from-emerald-400 to-teal-600",
    keywords: ["cashier", "handover", "drawer", "count", "shortage", "nisha"],
  },
  {
    id: "report",
    label: "Reports",
