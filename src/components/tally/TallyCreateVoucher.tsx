      ...
      <div className="bg-white border rounded-xl p-6 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Type to search (e.g. Cash, HDFC)…"
            className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <datalist id="account-ledgers">
            {allLedgers.map(l => <option key={l.name} value={l.name} />)}
          </datalist>
        ...
        <div>
          ...
          <input
            type="text"
            list="particulars-ledgers"
            value={form.particulars}
            onChange={e => setForm(f => ({ ...f, particulars: e.target.value }))}
            placeholder="Type to search (e.g. Salary, Maintenance)…"
            className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
          <datalist id="particulars-ledgers">
            {allLedgers.map(l => <option key={l.name} value={l.name} />)}
          </datalist>
        </div>
